  ...
  mower: {
    ...
    reviews: [
      ...
      },
      {
        ...
        stars: 2,
        review:
          "Disappointed. It struggles with my uneven lawn and frequently gets stuck on roots. The boundary wire installation was tedious and the customer support was unhelpful.",
    ...
    reviews: [
      {
        ...
        stars: 5,
        review:
          "These bulbs are fantastic! The warm white setting is perfect for evenings, and the daylight mode helps me focus when working. Setup with Alexa was seamless.",
